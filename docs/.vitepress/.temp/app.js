...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"三国对抗赛","description":"React + Vite 重构版本说明文档","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"首页","link":"/"},{"text":"玩法说明","link":"/gameplay"}],"sidebar":[{"text":"项目文档","items":[{"text":"重构概览","link":"/"},{"text":"玩法说明","link":"/gameplay"}]}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
